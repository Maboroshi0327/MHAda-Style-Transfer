...
def train():
    ...
    for epoch in range(EPOCH_START, EPOCH_END + 1):
        ...
        # Save model
        torch.save(vit_c.state_dict(), f"./models/ViT_MultiScale_C_epoch_{epoch}_batchSize_{BATCH_SIZE}.pth")
        torch.save(vit_s.state_dict(), f"./models/ViT_MultiScale_S_epoch_{epoch}_batchSize_{BATCH_SIZE}.pth")
        torch.save(model.state_dict(), f"./models/AdaMSViT_epoch_{epoch}_batchSize_{BATCH_SIZE}.pth")
